...
export default function Services() {
  ...
  const services: Service[] = [
    ...
    },
    {
      ...
      includes: ["Deployment & hosting", "Monitoring & backups", "Security & updates"],
      bestFor: ["Production websites & apps"],
    ...
    },
    {
      ...
      includes: ["Business analysis", "System design", "Tool selection", "Implementation support"],
      bestFor: ["Teams scaling without systems"],
    ...
    },
    {
      ...
      includes: ["KPI definitions", "Custom dashboards", "Data connections", "Ongoing sync"],
      bestFor: ["Operators & founders"],
